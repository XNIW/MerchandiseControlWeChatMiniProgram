...
Database: ricostruzione isolata PostgreSQL 17.6 dalle sole 141 migration dello staging e nuovo delta additive 20260912142454; le due commerce non incluse. Ruolo DDL postgres temporaneamente elevato soltanto nel container creato per questa prova, poi demozione prima dei test; utenti/ruoli reali service_role/anon/authenticated testati senza bypass. 309 controlli WeChat iniziali PASS; suite diretta estesa a 53 PASS con collisione/idempotenza. Le fixture sono isolate e i test pgTAP fanno rollback.
